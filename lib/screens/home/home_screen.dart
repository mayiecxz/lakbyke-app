...
class _HomeScreenState extends State<HomeScreen> {
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: _isLoading && _homeData == null
                      ? const AppLoadingOverlay(message: 'Loading your ride data...')
                      : RefreshIndicator(
                          onRefresh: () async {
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      _serviceTag == null
                                          ? AppLoadingSpinner(size: AppSpinnerSize.small)
                                          : Text(
                                              _serviceTag!,
  ...
  // Widget for the Battery Status. Default when no data: "No battery detected".
  Widget _buildBatteryStatus() {
    final batteryLevel = _homeData?['mountBatteryPercentage'];
    final bool hasBatteryData = batteryLevel != null;
    final int? batteryPercent = hasBatteryData
        ? (batteryLevel is int ? batteryLevel : (batteryLevel as num).toInt())
        : null;
          ...
          children: [
            ...
            _isLoading
                ? SizedBox(
                    height: 48,
                    child: Center(
                      child: AppLoadingSpinner(size: AppSpinnerSize.small),
                    ),
                  )
                : Text(
      ...
      child: Row(
        ...
        children: [
          _MetricItem(
            ...
            value: _isLoading ? null : (distance.abs() >= 1000 ? '${formatCompactNumber(distance, 1)}km' : '${distance.toStringAsFixed(1)}km'),
            label: 'Distance',
            subtitle: 'Today',
          ),
          _MetricItem(
            icon: Icons.flash_on,
            value: _isLoading ? null : '${effort.toInt()}W',
            label: 'Effort',
          ...
          _MetricItem(
            ...
            value: _isLoading ? null : (generated >= 1000000 ? '${formatCompactNumber(generated / 1000)} kWh' : formatEnergy(generated)),
            label: 'Generated',
            subtitle: 'Today',
          ),
        ],
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _ActionButton(
                ...
                value: _isLoading ? null : (totalGenerated >= 1000000 ? '${formatCompactNumber(totalGenerated / 1000)} kWh' : formatEnergy(totalGenerated)),
                color: AppColors.homePrimary,
                width: buttonWidth,
              ...
              _ActionButton(
                ...
                title: 'Total Redeems',
                value: _isLoading ? null : formatCompactCurrency(totalRedeems),
                color: AppColors.homePrimary,
                width: buttonWidth,
                isCurrency: true,
          ...
          _ActionButton(
            ...
            title: _isLoading ? null : '${batteriesExchanged >= 1000 ? formatCompactNumber(batteriesExchanged, 0) : batteriesExchanged} Batteries Exchanged',
            value: '',
            color: AppColors.homePrimary,
