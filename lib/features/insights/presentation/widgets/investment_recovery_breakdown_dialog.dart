          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      '(${formatCompactCurrency(model.totalEarnings)} ÷ ₱3,792) × 100 = ${model.roiProgressFormatted}%',
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w800,
                        color: AppColors.homePrimary,
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildVariableRow(
                    label: 'Remaining to breakeven',
                    description: '₱3,792 − Total earnings',
                    value: formatCompactCurrency(model.remainingToBreakeven),
                  ),
                  const Divider(height: 1, thickness: 1),
                  _buildVariableRow(
                    label: 'Breakeven date',
                    description: 'Today + (Remaining ÷ Daily average)',
                    value: model.breakevenDateFormatted,
                  ),
                  const Divider(height: 1, thickness: 1),
                  _buildVariableRow(
                    label: 'Daily average',
                    description: 'Your current earning pace',
